...
class MediaApi
{
     ...
     */
    public function mediaUpdateMediaPost($title, $id)
    {
        list($response) = $this->mediaUpdateMediaPostWithHttpInfo($title, $id);
        return $response;
    }
     ...
     */
    public function mediaUpdateMediaPostWithHttpInfo($title, $id)
    {
        $returnType = '\Smartcalls\Model\UpdateMediaResponseType';
        $request = $this->mediaUpdateMediaPostRequest($title, $id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function mediaUpdateMediaPostAsync($title, $id)
    {
        return $this->mediaUpdateMediaPostAsyncWithHttpInfo($title, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function mediaUpdateMediaPostAsyncWithHttpInfo($title, $id)
    {
        $returnType = '\Smartcalls\Model\UpdateMediaResponseType';
        $request = $this->mediaUpdateMediaPostRequest($title, $id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function mediaUpdateMediaPostRequest($title, $id)
    {
        // verify the required parameter 'title' is set
        if ($title === null || (is_array($title) && count($title) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $title when calling mediaUpdateMediaPost'
            );
        }
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
     ...
     */
    public function mediaUploadMediaPost($file)
    {
     ...
     */
    public function mediaUploadMediaPostWithHttpInfo($file)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function mediaUploadMediaPostAsync($file)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function mediaUploadMediaPostAsyncWithHttpInfo($file)
    {
        $returnType = '\Smartcalls\Model\UploadMediaResponseType';
        $request = $this->mediaUploadMediaPostRequest($file);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function mediaUploadMediaPostRequest($file)
    {
        // verify the required parameter 'file' is set
        if ($file === null || (is_array($file) && count($file) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $file when calling mediaUploadMediaPost'
            );
        }
