<?php
/**
 * RecoveryByEmailResponseTypeResultTest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * RecoveryByEmailResponseTypeResultTest Class Doc Comment
 *
 * @category    Class
 * @description Link to change the password sent to email, it will be active 2 hours
 * @package     Smartcalls
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RecoveryByEmailResponseTypeResultTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Test "RecoveryByEmailResponseTypeResult"
     */
    public function testRecoveryByEmailResponseTypeResult()
    {
    }
